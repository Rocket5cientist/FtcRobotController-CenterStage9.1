...
public class ContourTest extends LinearOpMode {
    ...
    static double heightOfCamera = 10.25;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double h = getDistance(width);
            telemetry.addData("Distance in Inch", h);
            telemetry.addData("Distance from Robot", getDistanceFromRobot(h));
            telemetry.update();
    ...
    private void initOpenCV() {
        ...
        controlHubCam = OpenCvCameraFactory.getInstance().createWebcam(
                hardwareMap.get(WebcamName.class, "OpenCV"), cameraMonitorViewId);
    ...
    class YellowBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat preprocessFrame(Mat frame) {
            ...
            Scalar lowerYellow = new Scalar(0, 0, 175);
            Scalar upperYellow = new Scalar(90, 90, 255);
    ...
    private static double getDistanceFromRobot(double H) {
